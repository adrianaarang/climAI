...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const tabHumedad = document.getElementById("tabHumedad");
  const tabLluvia  = document.getElementById("tabLluvia");

  tabTemp?.addEventListener("click", () => {
    tabTemp.classList.add("active");
    tabHumedad?.classList.remove("active");
    tabLluvia?.classList.remove("active");
    cargarGraficaTemp();
  });

  tabHumedad?.addEventListener("click", () => {
    tabHumedad.classList.add("active");
    tabTemp?.classList.remove("active");
    tabLluvia?.classList.remove("active");
    cargarGraficaHumedad();
  });

  tabLluvia?.addEventListener("click", () => {
    tabLluvia.classList.add("active");
    tabTemp?.classList.remove("active");
    tabHumedad?.classList.remove("active");
    cargarGraficaLluvia();
  });
